...
export const ContentsList = () => {
  return (
    <div className={`mt-12 ${classes.list}`}>
      <h3 className="text-xl font-bold">好きなものたち</h3>

      <ul>
        <li className="mt-4">
          <h2 className="font-bold">今期のアニメ</h2>
          <ul>
            <li>
              ワンダーエッグ・プライオリティ
              <ul>
        ...
        <li className="mt-4">
          <h2 className="font-bold">ブランド</h2>
          <ul>
            <li>フロムソフトウェア</li>
            <li>すみっこソフト</li>
            <li>Key</li>
        ...
        <li className="mt-4">
          <h2 className="font-bold">ライター</h2>
          <ul>
            <li>王雀孫</li>
            <li>すかぢ</li>
            <li>衣笠彰梧</li>
